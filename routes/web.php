...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('login', 'AdminLoginController@getAdminLogin')->name('admin.getLogin');
    Route::post('login', 'AdminLoginController@postAdminLogin')->name('admin.postLogin');
...
Route::get('profile', 'UserController@getProfile')->name('user.getProfile')->middleware('UserMiddleware');
Route::post('profile', 'UserController@postProfile')->name('user.postProfile')->middleware('UserMiddleware');
Route::get('history', 'UserController@historyPayment')->name('user.historyPayment')->middleware('UserMiddleware');
