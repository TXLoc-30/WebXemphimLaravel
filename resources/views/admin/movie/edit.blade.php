...
<div class="container-fluid border-danger">
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.movie.edit',$movie->id) }}">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-3 pb-3">
                <img class="img-thumbnail" src="{{ asset('storage/poster/'.$movie->poster_image) }}" alt="" title="{{ asset('storage/poster/'.$movie->poster_image) }}">
                </div>
                <div class="col-md-9">
                    <div class="pb-3">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" class="uploadimg"
                                for="inputGroupFile01">{{ $movie->poster_image }}</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
